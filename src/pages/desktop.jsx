  ...
  return (
      ...
      <div className="product-section">
        ...
        <div className="product-grid">
          {[
            { name: "Nagi Deskmat", price: 350, src: "/assets/mousepad1.jpg" },
            { name: "Neko Deskmat", price: 400, src: "/assets/mousepad2.jpg" },
            { name: "Anime Girl Deskmat", price: 400, src: "/assets/mousepad3.jpg" },
            { name: "Mikasa Notebook", price: 200, src: "/assets/nb4.jpg" },
            { name: "Jujutsu Kaisen Notebook", price: 200, src: "/assets/nb5.jpg" },
            { name: "Demon Slayer Notebook", price: 200, src: "/assets/nb6.jpg" },
            { name: "Totoro Pen Holder", price: 450, src: "/assets/penholder1.jpg" },
            { name: "Colossal Pen Holder", price: 250, src: "/assets/penholder2.jpg" },
            { name: "Doraemon Pen Holder", price: 300, src: "/assets/penholder3.jpg" },
            { name: "Chainsaw Man Deskmat", price: 400, src: "/assets/mousepad4.jpg" },
            { name: "Gojo Satoru Deskmat", price: 400, src: "/assets/mousepad5.jpg" },
            { name: "Gengar Deskmat", price: 450, src: "/assets/mousepad6.jpg" },
          ].map((item, index) => (
