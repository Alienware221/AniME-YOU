...
const Plushies = () =>  {
  ...
  <div className="product-grid">
    {[
      { name: "Blue Girl Plush ", price: 350, src: "/assets/plush1.jpg" },
      { name: "The Strongest Plush", price: 350, src: "/assets/plush2.jpg" },
      { name: "Ghost Plush", price: 350, src: "/assets/plush3.jpg" },
      { name: "Green Hero Plush ", price: 350, src: "/assets/plush4.jpg" },
      { name: "Surgeon Plush", price: 350, src: "/assets/plush5.jpg" },
      { name: "Slayer Plush", price: 350, src: "/assets/plush6.jpg" },
      { name: "Volleyball Plush", price: 350, src: "/assets/plush7.jpg" },
      { name: "Volleyball Plush", price: 350, src: "/assets/plush8.jpg" },
      { name: "Psychic  Plush", price: 350, src: "/assets/plush9.jpg" },
      { name: "Cursed Speechi Plush", price: 350, src: "/assets/plush10.jpg" },
      { name: "PokeGhost Plush", price: 400, src: "/assets/plush11.jpg" },
      { name: "Poke Plant Plush", price: 400, src: "/assets/plush12.jpg" },
    ].map((item, index) => (
